...
- Email-verification sign-ups now return an opaque, enumeration-safe polling handle and expose `GET /auth/sign-up/status`; the route has a distinct configurable `polling` rate-limit budget.
